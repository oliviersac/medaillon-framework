class TransferLogWriter:
    ...
    def writeTransferLog(self,origin_type, origin_name, origin_table, destination_type, destination_name, destination_table, schema_used,
                         rows_received, rows_filtered, rows_deduped, rows_added, transfer_status, failed_reason):
        # Insert a new transfer log entry
       
        """
        Table columns: `origin_type`, 
        `origin_name`, 
        `origin_table`, 
        `destination_type`
        , `destination_name`,
